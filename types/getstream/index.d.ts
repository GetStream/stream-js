...
export class Collections {
  ...
  entry(collectionName: string, itemId: string, data: object): CollectionEntry;

  get(collectionName: string, itemId: string): Promise<object>;
  get(
  ...
  deleteMany(collectionName: string, ids: string[]): Promise<object>;
  deleteMany(
    collectionName: string,
    ids: string[],
    callback: RestCallback,
