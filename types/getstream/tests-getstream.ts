...
feed.follow('feedSlug', 'user', {activity_copy_limit: 10}, (err: object, httpResponse: object, body: object) => {}); // $ExpectType void
feed.follow('feedSlug', 'user', (err: object, httpResponse: object, body: object) => {}); // $ExpectType void
...
feed.unfollow('feedSlug', 'user', {keep_history: true}, (err: object, httpResponse: object, body: object) => {}); // $ExpectType void
feed.unfollow('feedSlug', 'user', (err: object, httpResponse: object, body: object) => {}); // $ExpectType void
